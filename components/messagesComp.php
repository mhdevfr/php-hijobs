<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <?php if (isset($_SESSION['userType']) && isset($_SESSION['userId'])): ?>
        ...
        <div class="bg-gray-100 p-4 mb-6 rounded-lg">
            ...
            <div class="text-sm">
                <!-- Affiche le type et l'ID de l'utilisateur -->
                ...
                try {
                    ...
                    // Affiche les détails des messages si disponibles
                    ...
                    // Vérifie si la variable $messages est définie
                    ...
                    // Affiche une erreur SQL en cas de problème
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-6">
            ...
            <div class="space-y-6">
                <?php
                // Vérifie si des messages sont disponibles
